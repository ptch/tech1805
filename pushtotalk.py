...
class SampleAssistant(object):
    ...
    def __init__(self, language_code, device_model_id, device_id,
                 ...
                 channel, deadline_sec, device_handler, notified, hearing_mode):
    ...
    def assist(self):
        ...
        for resp in self.assistant.Assist(iter_log_assist_requests(),
            ...
            if resp.speech_results:
                req_text = ' '.join(r.transcript for r in resp.speech_results)
                logging.info('Transcript of user request: "%s".', req_text)
                matchObj = re.search(u"です$", req_text.encode('utf-8'))
...
def main(api_endpoint, credentials, project_id,
    ...
    with SampleAssistant(lang, device_model_id, device_id,
                         ...
                         device_handler, False, False) as assistant:
        # If file arguments are supplied:
        # exit after the first turn of the conversation.
        # if input_audio_file or output_audio_file:
        #     assistant.assist()
        #     return
        audio_source_mic = audio_device = (
            audio_device or audio_helpers.SoundDeviceStream(
                sample_rate=audio_sample_rate,
                sample_width=audio_sample_width,
                block_size=audio_block_size,
        ...
        while True:
            ...
            conversation_stream._source = audio_source_mic
